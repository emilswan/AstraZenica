...
export const mockProducts: Product[] = [
  { id: 'prod1', sku: 'CP-AMX-500', name: 'Amoxicillin 500mg', description: 'Broad-spectrum antibiotic capsules', category: 'Antibiotics', unit: 'capsules', min_stock: 5000, reorder_point: 8000, unit_price: 0.15, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod2', sku: 'CP-PCT-1000', name: 'Paracetamol 1000mg', description: 'Analgesic and antipyretic tablets', category: 'Analgesics', unit: 'tablets', min_stock: 10000, reorder_point: 15000, unit_price: 0.08, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod3', sku: 'CP-IBU-400', name: 'Ibuprofen 400mg', description: 'NSAID anti-inflammatory tablets', category: 'Analgesics', unit: 'tablets', min_stock: 8000, reorder_point: 12000, unit_price: 0.12, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod4', sku: 'CP-MET-500', name: 'Metformin 500mg', description: 'Oral diabetes medication tablets', category: 'Antidiabetics', unit: 'tablets', min_stock: 6000, reorder_point: 9000, unit_price: 0.10, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod5', sku: 'CP-ATV-20', name: 'Atorvastatin 20mg', description: 'Cholesterol-lowering statin tablets', category: 'Cardiovascular', unit: 'tablets', min_stock: 4000, reorder_point: 6000, unit_price: 0.22, country: 'Ireland', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod6', sku: 'CP-OMP-20', name: 'Omeprazole 20mg', description: 'Proton pump inhibitor capsules', category: 'Gastrointestinal', unit: 'capsules', min_stock: 5000, reorder_point: 7500, unit_price: 0.18, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod7', sku: 'CP-AZT-250', name: 'Azithromycin 250mg', description: 'Macrolide antibiotic tablets', category: 'Antibiotics', unit: 'tablets', min_stock: 3000, reorder_point: 5000, unit_price: 0.35, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod8', sku: 'CP-AML-5', name: 'Amlodipine 5mg', description: 'Calcium channel blocker tablets', category: 'Cardiovascular', unit: 'tablets', min_stock: 4500, reorder_point: 7000, unit_price: 0.14, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod9', sku: 'CP-CFL-500', name: 'Ciprofloxacin 500mg', description: 'Fluoroquinolone antibiotic tablets', category: 'Antibiotics', unit: 'tablets', min_stock: 3500, reorder_point: 5500, unit_price: 0.28, country: 'Germany', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod10', sku: 'CP-DXM-10', name: 'Dexamethasone 10mg/ml', description: 'Corticosteroid injection vials', category: 'Corticosteroids', unit: 'vials', min_stock: 1500, reorder_point: 2500, unit_price: 1.20, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod11', sku: 'CP-VIT-C1000', name: 'Vitamin C 1000mg', description: 'Ascorbic acid effervescent tablets', category: 'Vitamins & Supplements', unit: 'tablets', min_stock: 8000, reorder_point: 12000, unit_price: 0.09, country: 'United Kingdom', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
  { id: 'prod12', sku: 'CP-INS-NPH', name: 'Insulin NPH 100IU/ml', description: 'Intermediate-acting insulin vials', category: 'Antidiabetics', unit: 'vials', min_stock: 800, reorder_point: 1200, unit_price: 8.50, country: 'Germany', is_active: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-01-01T00:00:00Z' },
]

export const mockInventory: InventoryItem[] = [
  { id: 'inv1', product_id: 'prod1', product: mockProducts[0], batch_number: 'BAT-2026-001', quantity: 12500, location: 'Warehouse A', expiry_date: '2028-06-30', status: 'available', created_at: '2026-01-10T00:00:00Z', updated_at: '2026-01-10T00:00:00Z' },
  ...
  { id: 'inv3', product_id: 'prod3', product: mockProducts[2], batch_number: 'BAT-2026-003', quantity: 9800, location: 'Warehouse B', expiry_date: '2028-03-31', status: 'available', created_at: '2026-01-15T00:00:00Z', updated_at: '2026-01-15T00:00:00Z' },
  { id: 'inv4', product_id: 'prod4', product: mockProducts[3], batch_number: 'BAT-2026-004', quantity: 4200, location: 'Warehouse A', expiry_date: '2028-09-30', status: 'available', created_at: '2026-02-01T00:00:00Z', updated_at: '2026-02-01T00:00:00Z' },
  ...
  { id: 'inv6', product_id: 'prod6', product: mockProducts[5], batch_number: 'BAT-2026-006', quantity: 6700, location: 'Warehouse A', expiry_date: '2028-06-30', status: 'available', created_at: '2026-02-10T00:00:00Z', updated_at: '2026-02-10T00:00:00Z' },
  ...
  { id: 'inv8', product_id: 'prod8', product: mockProducts[7], batch_number: 'BAT-2026-008', quantity: 3900, location: 'Warehouse A', expiry_date: '2028-12-31', status: 'available', created_at: '2026-03-01T00:00:00Z', updated_at: '2026-03-01T00:00:00Z' },
  ...
  { id: 'inv11', product_id: 'prod11', product: mockProducts[10], batch_number: 'BAT-2026-011', quantity: 14200, location: 'Warehouse A', expiry_date: '2028-04-30', status: 'available', created_at: '2026-03-15T00:00:00Z', updated_at: '2026-03-15T00:00:00Z' },
